      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="w-12 h-px bg-sage mb-8"></div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white p-6 border border-gray-100/50">
              <div className="text-2xl font-light text-sage mb-2">100%</div>
            ...
            <div className="bg-white p-6 border border-gray-100/50">
              <div className="text-2xl font-light text-sage mb-2">{intl.formatMessage({ id: 'about.experienceYears' })}</div>
            ...
            <div className="bg-white p-6 border border-gray-100/50">
              <div className="text-2xl font-light text-sage mb-2">{intl.formatMessage({ id: 'about.serviceDays' })}</div>
            ...
            <div className="bg-white p-6 border border-gray-100/50">
              <div className="text-2xl font-light text-sage mb-2">500+</div>
